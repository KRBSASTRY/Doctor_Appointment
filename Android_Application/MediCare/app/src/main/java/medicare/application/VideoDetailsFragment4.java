 ...
 */
public class VideoDetailsFragment4 extends DetailsSupportFragment {
    private static final String TAG = "VideoDetailsFragment4";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (Movie) getActivity().getIntent().getSerializableExtra(DetailsActivity4.MOVIE);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), medicare.application.activities.doctor_login.class);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), DetailsActivity4.SHARED_ELEMENT_NAME);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(DetailsActivity4.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
            ...
            if (item instanceof Movie) {
                ...
                Bundle bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                        ...
                                        DetailsActivity4.SHARED_ELEMENT_NAME)
                                .toBundle();
