 ...
 */
public class VideoDetailsFragment3 extends DetailsSupportFragment {
    private static final String TAG = "VideoDetailsFragment3";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (Movie) getActivity().getIntent().getSerializableExtra(DetailsActivity3.MOVIE);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), medicare.application.activities.patient_login.class);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), DetailsActivity3.SHARED_ELEMENT_NAME);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(DetailsActivity3.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
            ...
            if (item instanceof Movie) {
                ...
                Bundle bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                        ...
                                        DetailsActivity3.SHARED_ELEMENT_NAME)
                                .toBundle();
