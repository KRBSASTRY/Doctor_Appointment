 ...
 */
public class VideoDetailsFragment5 extends DetailsSupportFragment {
    private static final String TAG = "VideoDetailsFragment5";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (Movie) getActivity().getIntent().getSerializableExtra(DetailsActivity5.MOVIE);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), medicare.application.activities.patient_dashboard.class);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), DetailsActivity5.SHARED_ELEMENT_NAME);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(DetailsActivity5.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
            ...
            if (item instanceof Movie) {
                ...
                Bundle bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                        ...
                                        DetailsActivity5.SHARED_ELEMENT_NAME)
                                .toBundle();
