// AppointmentHistoryActivity.java
...
public class patient_Appointment_History extends AppCompatActivity {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                try {
                    ...
                    URL url = new URL("http://ec2-18-189-180-8.us-east-2.compute.amazonaws.com/patient_appointments_history");
            ...
            protected void onPostExecute(String jsonResponse) {
                ...
                if (jsonResponse != null) {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(patient_Appointment_History.this, "Error parsing JSON", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(patient_Appointment_History.this, "Failed to fetch appointment history", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
